        ...
        child: ListView(
          children: [
              ...
              children: [
                Expanded(
                  child: FilledButton.icon(
                    onPressed: () {
                      // isteğe bağlı: formu resetleyebilirsin
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    if (_tagTypes.length <= 1) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('At least one Tag Type must remain')),
                      );
                      return;
                    }
                    final ok = await showDialog<bool>(
            ...
            DropdownButtonFormField<int>(
              ...
              decoration: const InputDecoration(labelText: 'ATA EPC Filter'),
              isExpanded: true,
